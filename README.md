...
> [!NOTE]
> The Delete: noHL Tier 1 will only delete noHL Season packs. Episodes will be removed by the Orphan Scan when the tracker removes them as they are replaced with a season pack. This is to prevent affecting your average seeding time.
